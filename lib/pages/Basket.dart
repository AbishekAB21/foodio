    ...
    return Consumer<BasketProvider>(
      builder: (context, provider, child) {
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text("Basket", style: FontStyles.SemiBoldTextStyle(),),
          ),
          body: Obx(() {
                        ...
                        Expanded(
                          child: StreamBuilder(
                            ...
                            builder: (context, AsyncSnapshot snapshot) {
                              ...
                              if (snapshot.hasData) {
                                provider
                                    .calculateGrandTotal(snapshot.data.docs);
                                return Column(
                                  children: [
                                    Expanded(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          actions: [
                                                                            ...
                                                                            TextButton(
                                                                                onPressed: () {
                                                                                  provider.deleteCartItem(ds.id, context, ds["Name"]);
                                                                                  Navigator.pop(context);
                                                                                },
                                                                                child: Text(
                                                                                  "Delete",
