...
class AdminOrderDetailScreen extends StatelessWidget {
  ...
  const AdminOrderDetailScreen({Key? key, required this.orderDetails})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    var items = orderDetails['items'] as List<dynamic>;
    var userDetails = orderDetails['deliveryAddress'] as Map<String, dynamic>?;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text(
                "Ordered by: ${userDetails?["Name"]}, ${userDetails?["House"]}, ${userDetails?["Pin"]}",
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
              ),
              SizedBox(height: 10),
              Text(
